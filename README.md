...
of truth** — a 48-point snapshot test (`run-apsf-snapshot-test.ts`) validates it
...
cd backend && npx tsx run-apsf-snapshot-test.ts    # TS-as-truth snapshot (48 checks, no python)
